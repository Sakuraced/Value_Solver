...
from utils.loss import custom_loss, test_loss, new_test_loss
    ...
    for step_num in range(3):
        ...
        for epoch in progress_bar:
            ...
            if not use_penalty[step_num]:
                ...
                SPT, MST = custom_loss(P=pred_adj, g=Graph,loss_args=loss_args)
                loss = MST + SPT
            else:
                loss_args["use_unreached"] = True
                SPT, MST, unreached = custom_loss(P=pred_adj, g=Graph, loss_args=loss_args)
